...
This is Part 2 of a two-part analysis. In Part 1, we showed where capital sits across Ethereum. Here, we focus on how that capital behaves - how it moves, concentrates, and generates risk.
...
![ETH-only and aggregated capital share in the CryptoDaily brief](assets/smart-contracts-balance-composition-342b-cryptodaily.jpg)
...
| # | Project | Address | PPI | Self-minter tokens | Rank (by totalBalanceUsd) |
| --- | --- | --- | --- | --- | --- |
| 1 | [World Liberty Fi](https://ethplorer.io/address/0xfef30c262676de9af5e5e9ba999cf774000b14b4) | 0xfef3...14b4 | 100% | 1.1B WLFI | 35 |
| 2 | [Uniswap](https://ethplorer.io/address/0x1a9c8182c09f50c8318d769245bea52c32be35bc) | 0x1a9c...35bc | 100% | 984.4M UNI | 36 |
| 3 | [Bitget](https://ethplorer.io/address/0xdfe4b89cf009bffa33d9bca1f19694fc2d4d943d) | 0xdfe4...943d | 100% | 579M BGB | 63 |
| 4 | [Worldcoin](https://ethplorer.io/address/0xaee0360b73b5d01dad134f234d3a93adc1680e57) | 0xaee0...0e57 | 94.3% | 624M WLD | 50 |
| 5 | [Crypto.com](https://ethplorer.io/address/0xa023f08c70a23abc7edfc5b6b5e171d78dfc947e) | 0xa023...947e | 35.3% | 238M CRO | 39 |
...
| # | Project | Address | PPI | Self-minter tokens | Rank change | Real rank (by totalBalanceUsd) | New rank (without spam-filter) |
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | [Gnosis](https://ethplorer.io/address/0x849d52316331967b6ff1198e5e32a0eb168d039d) | 0x849d...039d | 72% | 49.1M | +1846 (!) | 2550 | 704 |
| 2 | [Gate.io](https://ethplorer.io/address/0x1c4b70a3968436b9a0a9cf5205c787eb81bb558c) | 0x1c4b...558c | 80.4% | 106.6M | +424 | 704 | 280 |
| 3 | [Gnosis](https://ethplorer.io/address/0x88ad09518695c6c3712ac10a214be5109a655671) | 0x88ad...5671 | 60.9% | 181.3M | +252 | 409 | 157 |
| 4 | [Bitfinex](https://ethplorer.io/address/0xc61b9bb3a7a0767e3179713f3a5c7a9aedce193c) | 0xc61b...193c | 100% | 5.85B | +93 | 97 | 4 (!) |
| 5 | [Gate.io](https://ethplorer.io/address/0xc882b111a75c0c657fc507c04fbfcd2cc984f071) | 0xc882...f071 | 42.4% | 168.0M | +38 | 86 | 48 |
| 6 | [Bitfinex](https://ethplorer.io/address/0x742d35cc6634c0532925a3b844bc454e4438f44e) | 0x742d...f44e | 20.6% | 80.4M | +20 | 119 | 99 |
...
Once capital is viewed in Aggregated terms, the key question is no longer where it sits, but how it behaves. Activity, volatility, and balance composition reveal a system where capital flows through a small number of liquidity hubs, and risk concentrates in specific structures rather than across the market as a whole:
