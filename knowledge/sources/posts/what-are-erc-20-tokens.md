...
*Beginners guide to getting started with ERC-20 Tokens | by Ethplorer and [Coinmarketcap](https://coinmarketcap.com/alexandria/article/what-are-erc-20-tokens-find-out-now-as-the-decentralized-finance-industry-takes-off).*

### **Table of Contents**

[What Are ERC-20 Tokens?](http:/#what-are-erc-20-tokens)
[How Does an ERC-20 Token Work?](http:/#how-erc20-work)
[Why Do We Need ERC-20 Tokens?](http:/#why-erc20-need)
[What Does This Have to do With the Decentralized Finance (DeFi) Industry?](http:/#what-defi)
[How Can You Make Sense of Real Use Cases for ERC-20 Tokens?](http:/#what-erc20-use-cases)
[How Do You Begin Trading and Using Tokens?](http:/#how-begin-erc20)


### <a name="what-are-erc-20-tokens"></a>What Are ERC-20 Tokens?

Created by Fabian Vogelsteller in 2015, the ERC-20 token is the technical standard used for all smart contracts on the Ethereum blockchain for token implementation.
‍
...
The ERC-20 standard outlines six different functions for the benefit of other tokens within the Ethereum network. These functions include the method in which tokens are transferred and the way users access data for a particular token. This ultimately ensures that all tokens perform in any place within the Ethereum network.
...
### <a name="how-erc20-work"></a>How Does an ERC-20 Token Work?
...
ETH itself is not an ERC-20 token; instead, there is a version of ETH called “Wrapped Ethereum,” [(WETH](https://coinmarketcap.com/currencies/weth/)) which is an ERC-20-compliant version of ETH. This means some decentralized applications (DApps) favor WETH instead of ETH for technical reasons such as trading. 
...
### <a name="why-erc20-need"></a>Why Do We Need ERC-20 Tokens?
...
### <a name="what-defi"></a>What Does This Have to do With the Decentralized Finance (DeFi) Industry?
...
### <a name="what-erc20-use-cases"></a>How Can You Make Sense of Real Use Cases for ERC-20 Tokens?
...
There is roughly $100 million of capital in these tokens, with 3.5 million transfers occurring daily as demonstrated by Ethplorer [here](https://ethplorer.io/index) and below.

[Image: 6023cd4f16cb7aadd11a7dea_nTSvsgC4fPSAdRC8xkfejGci34206sPnRwzFCLtL88HvMWQaswhcPQKb_SpQSCeccFtrEsRTV28eHrVo0kU8zGalg9kRTo7xNNlK7gERWzJ5r0JMWqpdXFQvmTkCUY8CftM4LRdJ.png]![Ethereum Tokens Index](ethereum_index.png "=1600x")

Blockchain explorers such [Ethplorer](https://ethplorer.io/) allow you to track all of the activity around these tokens [here](https://ethplorer.io/top).
...
‍
[Image: 6023cd4edca7ea9fbe060b01_i31wdv4hEUhi3spV_yYBZa_w4n3jUqfSSJpSW3S_QXqNykipBqb-zXsb4UXGjMy9jpi4hP_j1a80TsaazbcvWZh7mmY0YVtzeUfEOd0Wmwt0fvBNsXtdsdnKxluG25YFEJ4BPtUF.jpg]![Aave](aave.jpg "=1280x")
[Image: 6023cd4fcbe16002b0576888_uBLf4LUyfr1-lZ9NU1uMpcu8mHO4Z0JBFVNLe4dorkpsnnCBYAFVdKlw4_5-EkuALwVLZuMIuf0gCNxKiO8qX_NvNkjIue-R1prvOBRGCmW_MhEgEMjnxXq2XNpEaQDFwEttPFFm.jpg]
![Tether](tether.jpg "=1280x")
[Image: 6023cd4fdd255f0e3753a48c_QmChB1sv0PsOnQDlpIxyRpeW8b5DobSzIBo6hxijyQap3IYVCua7QLwW2Mxx2cx1YojDzLs0NApFZ9wthdHsOA-_eyPxsm5e22d29l8FJWusXC_o9riENONblLgZEOyCoA-cDvvR.jpg]![Wrapped Bitcoin](wrapped_bitcoin.jpg "=1280x")

### <a name="how-begin-erc20"></a>How Do You Begin Trading and Using Tokens?
...
[Image: 6023cd4fdca7eaa9b3060b5d_lGqBFIkuwjIMW2X4COOtIxjMFStFlRE3QueouQybaXl3egkFpWVIFqbuflzdVXwZBVbaC8OAXU-pRtZdUtjkiJ2UI2_-jrp2rHd5iNV2yVRfJKIDkfRHUm989j1IQgk0VX6GMHtV.png]![Search](search.png "=1600x")
‍
...
[Image: 6023cd4ffc7a1156262d58cb_xg-foWCawPUuuxySw4pT6AVZVVLVe-GuLcvAoFRg7UkJPFno_SoYL_OjNwG1RH7b7Ir0hEjQ0KpbSoDOzk2da77xwT-g-NZ9hqpG3t-_5VVVULHGzkL0e2LmK62_Bo7v43PIaB_t.png]![](big_address.png "=1600x")
‍
